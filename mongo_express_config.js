...
var mongoexpressUser = "<desired_mongodb_admin_interface_username>";
var mongoexpressPass = "<desired_mongodb_admin_interface_password>";
...
module.exports = {
  ...
  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || mongoexpressUser,
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || mongoexpressPass,
  },
